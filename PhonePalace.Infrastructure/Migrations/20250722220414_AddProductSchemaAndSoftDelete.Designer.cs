...
namespace PhonePalace.Infrastructure.Migrations
{
    ...
    [Migration("20250722220414_AddProductSchemaAndSoftDelete")]
    partial class AddProductSchemaAndSoftDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhonePalace.Domain.Entities.Inventory", b =>
                {
                    b.HasOne("PhonePalace.Domain.Entities.Product", "Product")
                        .WithOne("Inventory")
                        .HasForeignKey("PhonePalace.Domain.Entities.Inventory", "ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
